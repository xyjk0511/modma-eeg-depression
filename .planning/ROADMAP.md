...
- [x] **Phase 13: Resting-State EEG Classification** - 用MODMA静息态EEG（128通道，5分钟/人）提取频段功率特征，LOSO分类MDD vs HC，与ERP结果对比 (completed 2026-02-23)
...
| 13. Resting-State EEG Classification | 1/1 | Complete (negative: BA=0.391) | 2026-02-23 |
